      ...
      <Card className="border-border shadow-sm flex-shrink-0">
        <CardContent className="p-4">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-6 gap-4">
            ...
            <div>
              <select 
                className="w-full h-10 px-3 py-2 rounded-md border border-primary/20 bg-primary/5 text-primary text-sm ring-offset-background placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2"
                value={selectedDept}
